...
/**
 * 添加笔记预览状态下的事件监听器，如标签、todo复选框、流程图
 */
class PreviewPlugins extends Component<{ container: IMain }, {}> {
  ...
  __mermaidOpenExternalClick = (event) => {
    ...
    const html = ($svg.clone().removeAttr("style")[0] as any).outerHTML, // Removing the style attribute, ensuring the svg is displayed at full-width

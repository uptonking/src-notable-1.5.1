...
const getHeight = () =>
    is.macos ? window.innerHeight - 38 : window.innerHeight, //UGLY: But it gets the job done, quickly
  getItemChildren = (tag: TagObj) =>
    !tag.collapsed ? Tags.sort(Object.values(tag.tags)) : [],
